...
<html lang="en">
  ...
  <?php
      ...
      $produit = "SELECT * FROM `". $categorie ."` WHERE ID ='". $id ."'";

      $requeteproduit = mysqli_query($bdd, $produit);

      $Affiche = mysqli_fetch_assoc($requeteproduit);
                        ...
                        <div class="aa-product-details-content">
                          <div class="row">
                            ...
                            <div class="col-md-5 col-sm-5 col-xs-12">                              
                              ...
                              <img src="img/photobdd/'. $Affiche['photo'] .'" class="simpleLens-big-image">
                              </div>
                            </div>
                            <!-- Modal view content -->
                            <div class="col-md-7 col-sm-7 col-xs-12">
                              <div class="aa-product-view-content">
                                ...
                                <div class="aa-price-block">
                                  <span class="aa-product-view-price">'. $Affiche['prix'] .'€</span>
                                ...
                                <div class="aa-prod-view-bottom">
                                  <form action="AjoutPanier.php" method="post">
                                    <a class="aa-add-card-btn">
                                      <span class="fa fa-shopping-cart"></span>
                                      <input type="hidden" name="Type" value="'. $Affiche['categorie'] .'"/>
                                      <input type="hidden" name="Produit" value="'. $Affiche['ID'] .'"/>
