       ...
       <div class="col-md-12">
         <div class="cart-view-area">
           <div class="cart-view-table">
                  ...
                  <table class="table">
                    ...
                    <?php
                        ...
                        for($i = 0; $i < sizeof($_SESSION['Panier']); $i++){
                          ...
                          $Requete = "SELECT * FROM `". $_SESSION['PanierType'][$i] ."` WHERE ID = '". $_SESSION['Panier'][$i] ."'";

                          $Resultat = mysqli_query($bdd, $Requete);

                          $Panier = mysqli_fetch_assoc($Resultat);

                          echo '<tr>
                                  <td><a href="#"><img width="250" height="350" src="img/photobdd/'. $Panier['photo'] .'" alt="img"></a></td>
                                  <td><a class="aa-cart-title" href="">'. $Panier['nom'] .'</a></td>
                                  <td>'. $Panier['prix'] .'€</td>
                                </tr>';
             ...
             <!-- Cart Total view -->
               <a href="checkout.html" class="aa-cart-view-btn">Procéder au paiement</a>
             </div>
           </div>
         </div>
       </div>
