  ...
  <?php
      if (isset($_SESSION['Connecté'])){
        ...
        switch ($_SESSION['Type']) {
          case 'admin':
            $requeteadmin = "SELECT * FROM administrateur WHERE pseudo = '" . $_SESSION['Pseudo'] . "'";

            $resultatadmin = mysqli_query($bdd, $requeteadmin);

            $Admin = mysqli_fetch_assoc($resultatadmin);

            echo '<section id="aa-myaccount">
                    <div class="container">
                      <div class="row">
                        <div class="col-md-12">
                              ...
                              <div class="col-md-6">
                                <div class="aa-myaccount-login">
                                  ...
                                  <form  class="aa-login-form" action="" method="post">
                                    ...
                                    <input type="text" name="email" value="'. $Admin['email'] .'" disabled="disabled">
                                    <label for="">Pseudo<span></span></label>
                                    <input type="text" name="pseudo" value="'. $Admin['pseudo'] .'" disabled="disabled">
                                    <label for="">Nom<span></span></label>
                                    <input type="text" name="nom" value="'. $Admin['nom'] .'" disabled="disabled">
                                  </form>
                                </div>
                              </div>
                            </div>          
          ...
          case 'vendeur':
            $requetevendeur = "SELECT * FROM vendeur WHERE pseudo = '" . $_SESSION['Pseudo'] . "'";

            $resultatvendeur = mysqli_query($bdd, $requetevendeur);

            $Vendeur = mysqli_fetch_assoc($resultatvendeur);
                          ...
                          <div class="aa-myaccount-area">         
                            <div class="row">
                              <div class="col-md-6">
                                <div class="aa-myaccount-login">
                                  <h4>Votre Profil</h4>
                                  <form  class="aa-login-form" action="Modification.php" method="post">
                                    <label for="">Adresse Email<span>*</span></label>
                                    <input type="text" name="email" value="'. $Vendeur['email'] .'" disabled="disabled">
                                    <label for="">Pseudo<span></span></label>
                                    <input type="text" name="pseudo" value="'. $Vendeur['pseudo'] .'" disabled="disabled">
                                    <label for="">Nom<span></span></label>
                                    <input type="text" name="nom" value="'. $Vendeur['nom'] .'" disabled="disabled">
                                    <label for="">URL Photo<span></span></label>
                                    <input type="text" name="photo" value="'. $Vendeur['photo'] .'">
                                    <label for="">URL Image de fond<span></span></label>
                                    <input type="text" name="idf" value="'. $Vendeur['image de fond'] .'">
                                  </form>
                                </div>
                              </div>
                            </div>          
          ...
          case 'acheteur':
            $requeteacheteur = "SELECT * FROM acheteur WHERE Pseudo ='" . $_SESSION['Pseudo'] . "'";

            $resultatacheteur = mysqli_query($bdd, $requeteacheteur);

            $Acheteur = mysqli_fetch_assoc($resultatacheteur);
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                <div class="aa-myaccount-login">
                                  ...
                                  <form  class="aa-login-form" action="Modification.php" method="post">
                                    <label for="">Pseudo<span></span></label>
                                    <input type="text" name="email" value="'. $Acheteur['email'] .'" disabled="disabled">
                                    <label for="">Mot de passe<span></span></label>
                                    <input type="password" value="'. $Acheteur['mdp'] .'" name="pseudo" disabled="disabled">
                                    <label for="">Nom<span></span></label>
                                    <input type="text" name="pseudo" value="'. $Acheteur['pseudo'] .'" disabled="disabled">
                                    <label for="">Adresse Email<span></span></label>
                                    <input type="text" name="nom" value="'. $Acheteur['nom'] .'" disabled="disabled">
                                    <label for="">Prénom<span></span></label>
                                    <input type="text" name="prenom" value="'. $Acheteur['prenom'] .'" disabled="disabled">
                                    ...
                                    <label for="">Code Postale<span></span></label>
                                    <input type="text" name="CP" value="'. $Acheteur['code_postale'] .'">
                                    <label for="">Pays<span></span></label>
                                    <input type="text" name="Pays" value="'. $Acheteur['pays'] .'">
                                    <label for="">Numéro<span></span></label>
                                    <input type="text" name="numero" value="'. $Acheteur['numero'] .'">

                                    <button type="submit" class="aa-browse-btn">Modifier</button> 
                                  </form>
                                </div>
                              </div>
                            </div>          
                              ...
                              <label for="">Adresse Email<span>*</span></label>
                               ...
                               <label for="">Mot de passe<span>*</span></label>
                                <input type="password" placeholder="Mot de passe/Pseudo" name="pseudo" required>
                                 <button type="submit" class="aa-browse-btn">Connexion</button> 
                              </form>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="aa-myaccount-register">                 
                             <h4>Inscription</h4>
                             <form action="Inscription.php" method="post" class="aa-login-form">
